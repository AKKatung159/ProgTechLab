...
public class QuestionTester {
    public static void main(String[] args) {
        ...
        ChoiceQuestion question = new ChoiceQuestion("In which country was country was the inventor of Java born?");
        ...
        fiQuestion.constructQuestionAndAnswer("The medthod that returns a string representation for each object is _ toString");
        quiz[3]=fiQuestion;
